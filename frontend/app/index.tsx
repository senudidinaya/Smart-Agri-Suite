...
const getTheme = (mode: ThemeMode) => {
    if (mode === "farmer") {
        ...
        return {
            ...
            badgeText: "#16a34a",
            statusInactiveBg: "rgba(100, 116, 139, 0.1)",
...
// Helper to get card title — uses langConfig for known ids, falls back to comp.title
function getCardTitle(comp: typeof COMPONENTS[0], langConfig: any): string {
    const keyMap: Record<string, string> = {
        idle_land: 'mod.idleLand.title',
...
// Helper to get card subtitle
function getCardSubtitle(comp: typeof COMPONENTS[0], langConfig: any): string {
    const keyMap: Record<string, string> = {
        idle_land: 'mod.idleLand.sub',
                                ...
                                renderItem={({ item }) => (
                                    <Pressable
                                        style={[
                                            ...
                                            { backgroundColor: theme.cardBg, borderColor: theme.borderColor },
                                            !item.read && { backgroundColor: theme.badgeBg, borderColor: theme.badgeBorder, borderWidth: 2 }
                                        ]}
