...
import { fetchWeather } from "../../../../services/pricing/api";
...
export default function HomeScreen() {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <Pressable
        style={{ position: 'absolute', top: 16, left: 16, zIndex: 10, flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(76, 175, 80, 0.1)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 }}
        onPress={() => router.replace("/")}
      >
        <Ionicons name="arrow-back" size={16} color="#4CAF50" />
        <Text style={{ marginLeft: 6, color: "#4CAF50", fontWeight: "600", fontSize: 13 }}>Main Dashboard</Text>
      </Pressable>
      ...
      <Pressable
        ...
        onPress={() => router.push("/pricing/explore" as any)}
      >
