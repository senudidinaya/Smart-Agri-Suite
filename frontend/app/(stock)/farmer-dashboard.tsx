...
const styles = StyleSheet.create({
  ...
  topBarText: { fontSize: 18, color: COLORS.textPrimary, fontWeight: '500' },
  scroll: { flex: 1, backgroundColor: COLORS.background },
  scrollContent: { padding: 16, paddingBottom: 40 },
  header: { marginBottom: 20, marginTop: 8 },
  headerRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 },
  brandTitle: { fontSize: 28, fontWeight: '800', color: COLORS.brandDark, letterSpacing: -0.5 },
  brandSubtitle: { fontSize: 14, fontWeight: '600', color: '#64748b', marginBottom: 4 },
  brandDescription: { fontSize: 13, color: '#94a3b8', lineHeight: 18 },
