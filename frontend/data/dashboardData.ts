...
export const SPICE_IMAGES: Record<string, any> = {
  'Cardamom': require('../assets/cardamom_spice_isolated.png'),
  'Cinnamon': require('../assets/cinnamon_sticks_isolated.png'),
  'Clove': require('../assets/clove_spice_isolated.png'),
  'Nutmeg': require('../assets/nutmeg_seed_isolated.png'),
  'Pepper': require('../assets/black_pepper_isolated.png'),
};
