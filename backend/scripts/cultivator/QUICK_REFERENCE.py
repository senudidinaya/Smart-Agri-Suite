...
READY_COMPONENTS = {
    "decision_engine": {
        ...
        "status": "✅ READY",
        "imports": "from cultivator.services.decision_engine import get_decision_engine",
        "methods": {
...
Code:
    from cultivator.services.decision_engine import get_decision_engine
    from cultivator.schemas.prediction import CultivatorDecisionResponse, GateDecisionDetail
