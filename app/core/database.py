...
async def _create_indexes() -> None:
    ...
    # Spice Marketplace indexes
    await db.spices.create_index("name", unique=True)
    await db.spice_items.create_index([("spiceId", 1), ("createdAt", 1)])
    await db.spice_items.create_index("farmerId")
